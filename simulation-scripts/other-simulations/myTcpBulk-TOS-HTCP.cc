...
//
  ...
  //set link error to simulate packet loss
...
//
  ...
  pointToPoint.SetDeviceAttribute ("DataRate", StringValue ("1000000Kbps"));
...
//
  ...
  InetSocketAddress destAddress (i.GetAddress (1), port);
